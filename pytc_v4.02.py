...
# python 2
''' 
PyTC: A Python Toolkit for Text Classification with BOW (Bags-of-words) Representation
Version: V4.02
Date: 2014-9-6
'''
...
def save_text_f2(save_dir, samp_tag, doc_str_list, doc_class_list):
    '''text format 2: one class one file, docs are separated by samp_tag
    '''
...
def build_samps(term_dict, class_dict, doc_terms_list, doc_class_list,
    ...
    class_dict -- negative:1; positive:2; unlabeled:0
    '''
    samp_dict_list = []
    samp_class_list = []
    for k in range(len(doc_class_list)):
...
#    train_dir = r'dataset\kitchen_token_5folds\fold1\train'
